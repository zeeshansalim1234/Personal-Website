...
(function($){
	...
	function startImageHeader(){
		...
		activeinfo.text(dataHeader[activeIndex].brief);

		PrevAuthor.text("at " + dataHeader[prevIndex].author);
		PrevTitle.text(dataHeader[prevIndex].title);
		NextAuthor.text("at " + dataHeader[nextIndex].author);
...
(function($){
	...
	Email.send({
		Host : "smtp.gmail.com",
		Username : "zeeshanwarrior567@gmail.com",
		Password : "zeeshan1234",
		To : 'zeeshanwarrior567@gmail.com',
		From : "zeeshanwarrior567@gmail.com",
